...
export default function OutageConsumersDashboard() {
  ...
  const C = {
    ...
    affected: "#2b0074ff", healthy: "#868d8c87", header: "#f1f5f9"
  };
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", marginBottom: 8 }}>
          ...
          <div style={{ marginLeft: "auto", display: "flex", gap: 8, alignItems: "center" }}>
            <input
              ...
              style={{ padding: "6px 10px", border: `1px solid ${C.border}`, borderRadius: 8, background: "#fff", color: C.text, width: 260 }}
            />
            <label style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12, color: C.subtext }}>
            ...
            <div style={{ position: "relative", height: 320 }}>
              ...
              <div style={{ position: "absolute", inset: 0, display: "grid", placeItems: "center", pointerEvents: "none" }}>
                <div style={{ textAlign: "center" }}>
                  <div style={{ fontSize: 44, fontWeight: 800, lineHeight: 1, color: C.affected }}>{totals.pct}%</div>
            ...
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
                <thead>
                  <tr style={{ textAlign: "left", color: C.subtext }}>
                    <th style={thStyle(C)}>Substation</th>
                    <th style={{ ...thStyle(C), textAlign: "center" }}>Consumers</th>
